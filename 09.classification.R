...
plot(sunc)
#just plot the two and see where the colour overlaps; in my case class 2 (yellow) corresponds to the higher energy and class 3 (green) correrponds to the lower energy 
